...
$id=$_REQUEST['id'];
	if(!empty($_REQUEST['mode']))
	{
					...
					$details=$_REQUEST['details'];
							...
							$sql_update="UPDATE `travel_news` SET
										 `title`='$name',	
										 `details`='$details'
										 WHERE `id`='$id'";										 
							...
							if($res_update)
							{
								header("Location: news_mgt.php?msg=successfull edit");
								exit();
							}
...
<input type="hidden"  name="id" id="id" value="<?php echo $id; ?>" >		
		 ...
		 <tr class="mysty2" bgcolor="#A9B63D" height="18">
    				<td colspan="2" class="mysty2" align="center" bgcolor="#A9B63D"><span class="style2"><strong><font color="#ffffff">Edit News</font></strong></span></td>
		  </tr>
...
<td width="332"><input name="name" size="48" id="name" type="text" value="<?php echo $row_news['title']; ?>"></td>
</tr>
<tr>
<td height="5">&nbsp;</td>
<td height="5">&nbsp;</td>
...
<td width="332"><textarea name="details" id="details" cols="36" rows="10"><?php echo $row_news['details']; ?></textarea>
</td>
</tr>
<tr>
<td height="5">&nbsp;</td>

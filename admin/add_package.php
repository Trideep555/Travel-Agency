...
include("../lib/connection.php");  
	if(!empty($_REQUEST['mode']))
	{
					...
					$details=$_REQUEST['details'];
							...
							$sql_insert="INSERT INTO `travel_package` SET
										 `name`='$name',
										 `details`='$details'";
							$res_insert=mysqli_query($con,$sql_insert);
							if($res_insert)
							{
								header("Location: package_mgt.php?msg=successfull insert");
								exit();
							}
...
<input type="hidden"  name="mode" id="mode" value="1" >					
		 ...
		 <tr class="mysty2" bgcolor="#A9B63D" height="18">
    				<td colspan="2" class="mysty2" align="center" bgcolor="#A9B63D"><span class="style2"><strong><font color="#ffffff">Insert Package</font></strong></span></td>
		  </tr>
